...
def InferenceTensorFlow(image, model, label=None):
    ...
    rectangles = []
    for i, score in enumerate(detected_scores[0]):
...
def main():
    model = '/home/pi/Desktop/robot/tflite/tflite2/custom_model_lite/detect_quant.tflite'
    label_file = '/home/pi/Desktop/robot/tflite/tflite2/others/coco_labels.txt'
    ...
    while True:
        ...
        _ = InferenceTensorFlow(grey, model, label_file)
