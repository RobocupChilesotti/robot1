    ...
    if objects:
        for obj in objects:
            ...
            if(TipoPallina==0):
                ...
                if(TipoPallina==1):
                    #pallina nera
                    cv2.rectangle(frame, (xmin,ymin), (xmax,ymax), (255,20, 0), 2)
                    if(score>maxNera):
                        nera=(y,x)
                        maxNera = score
                    ...
                    if(TipoPallina==2):
                        ...
                        if(TipoPallina == 3):
                            ...
                            if(dim>maxBump):
                                ...
                                ymax = int(y+deltaYB//4)
                                ymin = int(y-deltaYB//4)
                                xmax = int(x+deltaXB//4)
                                xmin = int(x-deltaXB//4)
                                
                                bump = (ymin,ymax,xmin,xmax)
        ...
        return frame, bianca, nera, ostacolo,bump
    else:
